...
from .configuration import router as configuration_router  # ← NUEVO
...
api_router.include_router(configuration_router, prefix="/configuration", tags=["Configuration"])  # ← NUEVO